...
public class RegistroController {
    ...
    public List<Local> getLocalesByPersona(@PathVariable Integer id,
                                           @RequestParam(name = "fechaDesde") @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date fechaDesde,
                                           @RequestParam(name = "fechaHasta") @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date fechaHasta){
